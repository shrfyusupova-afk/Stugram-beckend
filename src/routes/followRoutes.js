...
router.get("/:username/followers", optionalAuth, validate(followListSchema), followController.getFollowers);
router.get("/:username/following", optionalAuth, validate(followListSchema), followController.getFollowing);
